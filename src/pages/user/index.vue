  ...
  <div @click="clickHandle">
    <view>
      <view class="user">
        ...
        <i-input :value="name" @change="changeName($event)"  autofocus placeholder="请输入用户名" maxlength="20" />
      </view>
      <view class="psd">
    ...
    <view class="lcv">
      <text style="frontsize:25px">no number?</text><text>&nbsp;&nbsp;&nbsp;&nbsp;</text><image style = "width:20px;height:20px" src="/static/grid/wechat.png"></image>
    </view>
    </view>
  </div>
</template>
